  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-fin-dark-bg/90 backdrop-blur-md">
      <div className="bg-fin-charcoal-light w-full max-w-md rounded-3xl border border-gray-800 p-6 relative">
        ...
        <h3 className="text-xl font-black italic text-white mb-4">EDITAR CLIENTE</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-fin-charcoal border border-gray-700 rounded-xl p-3 text-white text-sm outline-none"
              required
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-fin-violet text-white font-black py-3 rounded-xl hover:opacity-90 flex items-center justify-center gap-2"
          >
